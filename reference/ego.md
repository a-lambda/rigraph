...
ego(g, order = 0, 1:3)
#> [[1]]
#> ── <vertex sequence> 1/10 · from e18e2e2 ───────────────────────────────────────
#> [1] 1
#> 
#> [[2]]
#> ── <vertex sequence> 1/10 · from e18e2e2 ───────────────────────────────────────
...
ego(g, order = 1, 1:3)
#> [[1]]
#> ── <vertex sequence> 3/10 · from e18e2e2 ───────────────────────────────────────
#> [1]  1  2 10
#> 
#> [[2]]
#> ── <vertex sequence> 3/10 · from e18e2e2 ───────────────────────────────────────
...
ego(g, order = 2, 1:3)
#> [[1]]
#> ── <vertex sequence> 5/10 · from e18e2e2 ───────────────────────────────────────
#> [1]  1  2 10  3  9
#> 
#> [[2]]
#> ── <vertex sequence> 5/10 · from e18e2e2 ───────────────────────────────────────
