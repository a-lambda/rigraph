...
g
#> IGRAPH 3501aae UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 3501aae (vertex names):
...
g2
#> IGRAPH af9c23e UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from af9c23e (vertex names):
...
g3
#> IGRAPH 2fc8899 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 2fc8899 (vertex names):
...
g4
#> IGRAPH 7b7c0cc UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 7b7c0cc (vertex names):
...
g5
#> IGRAPH 0044878 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 0044878 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH c8a933e UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from c8a933e (vertex names):
#> [1] + ---   * --/   %%--%/%
```
