...
#> IGRAPH 652a463 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 652a463:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8532fa5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8532fa5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH aa88830 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aa88830:
...
#> IGRAPH 860d4f4 D--B 15 20 -- Bipartite Gnm random graph
