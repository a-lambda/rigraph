...
#> IGRAPH 6d825ce U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6d825ce:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4024531 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4024531:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ab3b7e8 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ab3b7e8:
...
#> IGRAPH 201ba2a D--B 15 20 -- Bipartite Gnm random graph
